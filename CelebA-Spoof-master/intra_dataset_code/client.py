...
LOCAL_ROOT = './'  # Đường dẫn gốc là thư muc hiện tại
LOCAL_IMAGE_LIST_PATH = 'Data/test_label.json'
...
def read_image(image_path):
    ...
    image_path = LOCAL_ROOT + 'Data/' + image_path
...
def get_image(max_number=None):
    ...
    for idx, image_id in enumerate(image_list):
        ...
        if n == Batch_size or idx == len(image_list) - 1:
            ...
            np_final_image = np.array(final_image, dtype=object)   # before: non 'dtype=object'
            n = 0
            final_image = []
            final_image_id = []
